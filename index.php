        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/" alt=""> </a>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
                                ...
                                <li class="nav-item"><a href="restaurant registration.php" class="nav-link active">Restaurant registration</a> </li>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Panda shop 2.0 </h2>
                    <p class="lead">Easiest way to order</p>
                </div>
                <div class="row">
						<?php 					
